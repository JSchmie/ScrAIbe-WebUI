...
from .multi import start_model_worker, timer_thread
from .interface import gradio_sync_Interface
from .loader import *


def sync_app(config : str = None, **kwargs):
    """
    ...
    config = SyncLoader.load_config(config, **kwargs)
    ...
    interface = gradio_sync_Interface(layout)
